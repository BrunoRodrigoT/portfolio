    ...
    <div className="w-full md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-3xl italic">
         I have been working in front-end development since 2022, starting at Tascom Tecnologia, with a focus on building modern interfaces, strong attention to user experience (UX), and high-quality interactions.
        </p>
      </div>
